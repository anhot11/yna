            ...
            if v <= 2:
                ...
                if (w == 3 or w == 4 or w == 5):
                    ...
                    if u == 1 or u == 3:
                        ...
                        pt.co_deform.y -= 0.55 * w_weight * (1.0 - y_frac * 0.4)

                # 2. Harmonious Thigh Base (w = 1, 2)
                if (w == 1 or w == 2):
...
preview_rear = r"C:\Users\kiosk\.gemini\antigravity-cli\brain\c69cd41b-33a7-42a9-9d33-a8d52789ab72\preview_true_peach_rear.png"
...
preview_3q = r"C:\Users\kiosk\.gemini\antigravity-cli\brain\c69cd41b-33a7-42a9-9d33-a8d52789ab72\preview_true_peach_3q.png"
