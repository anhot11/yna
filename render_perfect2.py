...
# Transform so Height=Z, Front=+Y, Rear=-Y
...
# Camera looking directly at buttocks: (0, -1.6, 0.82), rotation (90 deg, 0, 0)
cam_obj.location = (0, -1.6, 0.82)
...
bpy.context.scene.render.filepath = r"I:\workzone\gotot\yna\test_realistic_perfect2.png"
bpy.ops.render.render(write_still=True)
print("Saved test_realistic_perfect2.png")
