...
# Apply Multires at level 1 for smooth realistic curves
...
print(f"Body Mesh Vertices: {len(body.data.vertices)}")
...
for i, v in enumerate(body.data.vertices):
    ...
    # Buttocks & pelvis range: height Z from 0.72 to 0.94
    is_panty = False
    if 0.73 <= z <= 0.94:
        if z >= 0.83:
            is_panty = True
...
print("Realistic character successfully exported to:", out_glb)
