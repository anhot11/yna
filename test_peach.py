        ...
        for u in range(lat_data.points_u):
            ...
            if v <= 2 and (w == 3 or w == 4 or w == 5):
                ...
                if u == 1 or u == 3:
                    ...
                    pt.co_deform.x += sign_u * 0.45 * w_weight
                    # Perkiness lift
                    if w == 3:
            ...
            if v <= 2 and (w == 1 or w == 2):
                ...
                if u == 1 or u == 3:
                    pt.co_deform.y -= 0.60 * h_weight
                    sign_u = -1.0 if u == 1 else 1.0
                    pt.co_deform.x += sign_u * 0.22 * h_weight
...
# 1. Render Rear View
cam_data.lens_unit = 'FOV'; cam_data.angle = math.radians(42); cam_obj.location = (0, -1.35, 0.82)
cam_obj.rotation_euler = (math.radians(89), 0, 0)
preview_rear = r"C:\Users\kiosk\.gemini\antigravity-cli\brain\c69cd41b-33a7-42a9-9d33-a8d52789ab72\preview_peach_rear.png"
...
preview_3q = r"C:\Users\kiosk\.gemini\antigravity-cli\brain\c69cd41b-33a7-42a9-9d33-a8d52789ab72\preview_peach_3q.png"
