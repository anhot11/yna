...
# Load the scene from test_anatomy_v2
import sys
sys.path.append(r"I:\workzone\gotot\yna")

# Let us run test_anatomy_v2 with camera at 45 degree angle:
# Cam location: (0.9, -1.2, 0.85) looking at (0, 0, 0.82)
with open(r"I:\workzone\gotot\yna\test_anatomy_v2.py", "r", encoding="utf-8") as f:
    code = f.read()

# Replace camera location and preview path
